...
r2_multipleregression = r2_score(y_test,y_pred)
r2_multipleregressiontrain = r2_score(y_train,y_predtrain)
adjr2_multipleregression =1- ((1-r2_multipleregression)*(9132)/(9119))
MAPE_value_multiplelinearregression =np.mean(np.abs((y_test - y_pred) / y_test)) * 100